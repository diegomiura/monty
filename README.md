...
## 🔮 Next round: Final — model predictions

_Auto-generated by `python update_readme.py` — do not edit this section by hand._

Generated **2026-07-19T07:57:16Z** · model **v0.2.0** (rolling mode) · features through **2026-07-18**. Win/draw/win refers to the score after 90 minutes and sums to 1; advancement includes extra time and penalties. Every prediction is also stored in the append-only [prediction log](reports/predictions/world_cup_2026_predictions.csv).
